...
//        processing: true,
        ...
        columns: [
            ...
            {name: "Code", data: "CountryCode", orderable: false},
            {name: "Nombre", data: "Name"},
            {name: "Region", data: "Region", orderable: false},
            {name: "Continente", data: "Continent", orderable: false},
        ...
        ajax: {
            ...
            type: "POST",
            data: {
                operacion: "consultaPersonalizadaVariasTablas"
            },
...
// Open this row
            row.child(generarFilasByDatos(row.data(), ["CountryCode", "Name", "GovernmentForm"])).show();
            tr.addClass('shown');
        }
    });
});